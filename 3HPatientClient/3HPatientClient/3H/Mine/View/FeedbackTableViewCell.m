...
- (CustomTextView *)txtView{
    if (!_txtView) {
        _txtView = [[CustomTextView alloc] initWithFrame:CGRectMake(10, self.labLine.bottom +9, DeviceSize.width - 20, 200) placeholderFont:[UIFont systemFontOfSize:13] Color:[UIColor colorWithHEX:0x999999] Text:@"请输入您的反馈意见..."];
