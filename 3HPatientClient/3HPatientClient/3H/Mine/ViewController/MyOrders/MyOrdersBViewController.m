...
@interface MyOrdersBViewController ()<UIAlertViewDelegate,UIActionSheetDelegate>
...

{
    ...
    [packageParams setObject: @"wx0863c23f9e3f8d86"      forKey:@"appid"];       //开放平台appid
    [packageParams setObject: @"1295948201"  forKey:@"mch_id"];      //商户号
    ...
    if(prePayid){
        ...
        [signParams setObject: @"wx0863c23f9e3f8d86"               forKey:@"appid"];
        [signParams setObject: @"1295948201"           forKey:@"partnerid"];
...
- (NSString *)genSign:(NSDictionary *)signParams
{
    ...
    // 拼接API密钥
    NSString *result = [NSString stringWithFormat:@"%@&key=%@", signString, @"cygcDzUzi6y2POstWmOBa7EitvsPOTTW"];
    // 打印检查
    NSLog(@"result = %@", result);
    // md5加密
