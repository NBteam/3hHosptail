...
- (void)getNetWork{
    ...
    [[THNetWorkManager shareNetWork]getMyAccLogListPage:self.pageNO andCompletionBlockWithSuccess:^(NSURLSessionDataTask *urlSessionDataTask, THHttpResponse *response) {
