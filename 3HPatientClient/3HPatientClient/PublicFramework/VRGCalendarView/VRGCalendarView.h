...
#define kVRGCalendarViewWidth DeviceSize.width

#define kVRGCalendarViewDayWidth (DeviceSize.width -12)/7
#define kVRGCalendarViewDayHeight (DeviceSize.width -12)/7
