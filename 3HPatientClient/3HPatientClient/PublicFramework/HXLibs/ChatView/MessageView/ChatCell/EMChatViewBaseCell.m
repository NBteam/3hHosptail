...
//    [self.headImageView sd_setImageWithURL:[NSURL URLWithString:headImStr] placeholderImage:placeholderImage];
    ...
    if (messageModel.isSender) {
        [self.headImageView sd_setImageWithURL:messageModel.myHeadImage placeholderImage:placeholderImage];
    }else{
        [self.headImageView sd_setImageWithURL:messageModel.yourHeadImage placeholderImage:placeholderImage];
    }
}
