...
- (UITextField *)txtNameInput{
    if (!_txtNameInput) {
        ...
        if (self.index == 0) {
            ...
            _txtNameInput.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入药物剂量" attributes:@{NSForegroundColorAttributeName: [UIColor colorWithHEX:0x888888]}];
        }
