//
//  MessageListDetailTableViewCell.m
//  3HDoctorClient
//
...
@implementation MessageListDetailTableViewCell
...
- (CGFloat)confingWithDict:(NSDictionary *)model imgString:(NSString *)imgString{
    ...
    self.labRead.bottom = self.labDetail.bottom;
    
    return self.labDetail.bottom +12.5;
}
