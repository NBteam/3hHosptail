...
//    KYUser *user = [KYUser ReadLocalUserDataForPath:[UserPath stringByAppendingPathComponent:@"User"]];
    ...
    NSMutableDictionary *mutableExt = [[NSMutableDictionary alloc] initWithDictionary:ext];
//    [mutableExt setObject:user.head_photo==nil ?@"":user.head_photo forKey:@"userhead"];
   // ext = @{@"userhead":user.head_photo};
